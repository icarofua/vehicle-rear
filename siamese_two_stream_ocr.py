...
if __name__ == '__main__':
  ...
  if type1=='train':
    ...
    img1 = (process_load(data['img1'], input2)/255.0).reshape(1, input2[0], input2[1], input2[2])
    img2 = (process_load(data['img2'], input2)/255.0).reshape(1, input2[0], input2[1], input2[2])
